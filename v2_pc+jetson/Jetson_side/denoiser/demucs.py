...
from .utils import downsample2,upsample2
...
class Demucs(nn.Module):
    ...
    """
    def __init__(self,chin=1,chout=1,hidden=48,depth=5,kernel_size=8,stride=4,causal=True,resample=4,   #1,2 or 4
                 growth=2,max_hidden=10_000,normalize=True,glu=True,rescale=0.1,floor=1e-3):
